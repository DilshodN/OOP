...
TEST(BloomFilterCpp, InsertQueryTestDouble){
    ...
    BloomFilter* filter;
    filter = bloom_filter_new(128, (BloomFilterHashFunc)double_hash, 4);
    ...
    EXPECT_FALSE(bloom_filter_query(filter, (BloomFilterValue)&a));
    EXPECT_FALSE(bloom_filter_query(filter, (BloomFilterValue)&b));
    EXPECT_FALSE(bloom_filter_query(filter, (BloomFilterValue)&c));


    double_bf.insert(34.2);
    bloom_filter_insert(filter, (BloomFilterValue)&a);
    EXPECT_TRUE(double_bf.query(34.2));
    EXPECT_FALSE(double_bf.query(34.3));
    EXPECT_FALSE(double_bf.query(1));
    EXPECT_TRUE(bloom_filter_query(filter, (BloomFilterValue)&a));
    EXPECT_FALSE(bloom_filter_query(filter, (BloomFilterValue)&b));
    EXPECT_FALSE(bloom_filter_query(filter, (BloomFilterValue)&c));

    double_bf.insert(34.3);
    bloom_filter_insert(filter, (BloomFilterValue)&b);
    EXPECT_TRUE(double_bf.query(34.2));
    EXPECT_TRUE(double_bf.query(34.3));
    EXPECT_FALSE(double_bf.query(1));
    EXPECT_TRUE(bloom_filter_query(filter, (BloomFilterValue)&a));
    EXPECT_TRUE(bloom_filter_query(filter, (BloomFilterValue)&b));
    EXPECT_FALSE(bloom_filter_query(filter, (BloomFilterValue)&c));

    double_bf.insert(1);
    bloom_filter_insert(filter, (BloomFilterValue)&c);
    EXPECT_TRUE(double_bf.query(34.2));
    EXPECT_TRUE(double_bf.query(34.3));
    EXPECT_TRUE(double_bf.query(1));
    EXPECT_TRUE(bloom_filter_query(filter, (BloomFilterValue)&a));
    EXPECT_TRUE(bloom_filter_query(filter, (BloomFilterValue)&b));
    EXPECT_TRUE(bloom_filter_query(filter, (BloomFilterValue)&c));
...
TEST(BloomFilterCpp, InsertQueryTestString){
    ...
    BloomFilter* filter;
    filter = bloom_filter_new(128, (BloomFilterHashFunc)string_hash, 4);
...
TEST(BloomFilterCpp, LoadRead){
    ...
    filter1 = bloom_filter_new(128, int_hash, 4);
    filter2 = bloom_filter_new(128, int_hash, 4);
    ...
    for(int i = 0; i < 1000; i++){
        ...
        ASSERT_FALSE(bloom_filter_query(filter2, (BloomFilterValue)&i));
    }
...
TEST(BloomFilterCpp, Union){
    ...
    unsigned char state[16];
    result1 = bloom_filter_union(filter1, filter2);
    ...
    int a = 1;
    int b = 1;
    bloom_filter_insert(filter1, (BloomFilterValue)&a);
    bloom_filter_insert(filter1, (BloomFilterValue)&b);
    int_bf1.insert(1);
    int_bf2.insert(2);
    auto non_empty_union = int_bf1 | int_bf2;
    result2 = bloom_filter_union(filter1, filter2);
    EXPECT_EQ(non_empty_union.read(), std::bitset<3>{}.set());
    EXPECT_NE(bloom_filter_query(result2, (BloomFilterValue)&a), 0);
    EXPECT_NE(bloom_filter_query(result2, (BloomFilterValue)&b), 0);
...
TEST(BloomFilterCpp, Intersection){
    ...
    result1 = bloom_filter_intersection(filter1, filter2);
