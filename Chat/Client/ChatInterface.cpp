...
ChatInterface::ChatInterface(Client* data) : Fl_Double_Window(367, 244, "Chat Window") {
    chat_ui::client = data;
    ...
    text_display->highlight_data(text_style_buffer, style_table, sizeof(style_table) / sizeof(style_table[0]), 'Z',
                                 nullptr,
                                 nullptr);
...
ChatInterface::~ChatInterface() {
    delete(message_input);
    delete(text_display);
    delete(text_display_buffer);
    delete(text_style_buffer);
    delete(send_button);
}
...
void ChatInterface::SendButtonCallback(Fl_Widget *, void *data) {
...
void ChatInterface::CloseWindowCallback(Fl_Widget *, void *data) {
