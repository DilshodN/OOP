...
Matrix& Matrix::operator+=(const Matrix& mat) {
    /* совмещенный оператор сложения и присваивания. При невозможности выполнения операции объект, который вызывал
     данный оператор становится невалидным.
...
Matrix& Matrix::operator-=(const Matrix& mat) {
    /* совмещенный оператор вычитания и присваивания. При невозможности выполнения операции объект, который вызывал
     данный оператор становится невалидным.
     Т.е. при вызове метода isValid(), он вернет false.*/
    if(rows() != mat.rows() || cols() != mat.cols())
        return clean();
...
Matrix Matrix::operator*(const Matrix& mat) const {
    // оператор умножения матриц. При невозможности выполнения операции возвращает Matrix().
    if(cols() != mat.rows()) return Matrix();
...
Matrix Matrix::operator+(const Matrix& mat) const {
    // оператор сложения матриц. При невозможности выполнения операции возвращает Matrix().
